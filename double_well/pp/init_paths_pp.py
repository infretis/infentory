...
def gen_init_paths():
    ...
    orderp = np.loadtxt('/home/daniel/Documents/md/ps/com/1met_u/init1/md/merged.txt')
    traj = mda.Universe('/home/daniel/Documents/md/ps/com/1met_u/init1/md/merged.xtc')
